---
description: Affiche l'organigramme, le registre d'agents et les KPI.
---

Affiche l'organigramme, le registre d'agents et les KPI.

Exécute depuis la racine `company/` :

```bash
python orchestrator/orchestrator.py --org
```
