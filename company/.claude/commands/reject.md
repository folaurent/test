---
description: Rejette une décision en file. Usage: /reject <id>.
---

Rejette une décision en file. Usage: /reject <id>.

Exécute depuis la racine `company/` :

```bash
python orchestrator/orchestrator.py --reject $ARGUMENTS
```
