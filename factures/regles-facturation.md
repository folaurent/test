# Règles de facturation — JONCTION
...
- **Jours fériés non facturés**, selon le **pays du prestataire** :
  - Madagascar : 26/06 (Fête de l'Indépendance), etc.
  - France : 14/07 (Fête nationale), etc.
...
- Factures émises par **M. Laurent FOURNIER**, « au nom et pour le compte de la
  société JONCTION (SAS) en formation » ; actes **repris** à l'immatriculation.
- Ajouter le **SIRET** et le **n° de TVA intracommunautaire** dès réception du Kbis.
...
- Tél. : +33 6 27 89 37 42 — Greffe : RCS de Paris (en cours)
- E-mail : *à créer* — IBAN/BIC : *Qonto en cours d'ouverture*
